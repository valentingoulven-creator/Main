      ...
      <aside className="w-[400px] flex-shrink-0 flex flex-col h-full border-r"
        ...
        <header className="flex items-center gap-2 px-4 py-3 flex-shrink-0"
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-xs leading-none mt-0.5" style={{ color: profile.color }}>Melo</div>
          </div>
      ...
      <main className="flex-1 relative overflow-hidden">
        {geo.position ? (
          ...
          <div className="h-full flex flex-col items-center justify-center gap-4 text-center px-8">
            ...
            <div className="text-lg font-bold gradient-text">Melo</div>
            <p className="text-sm text-white/30 max-w-xs">Active la géolocalisation pour découvrir les auditeurs autour de toi</p>
