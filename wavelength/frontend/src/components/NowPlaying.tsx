...
import { SourceBadge } from './SourceLogo';
...
export default function NowPlaying({ profile, track, onEdit }: Props) {
  return (
    <div className="relative overflow-hidden rounded-2xl" style={{ minHeight: 112 }}>
      {/* Album art bg */}
      {track?.albumArt ? (
      ...
      <div className="absolute inset-0"
        style={{ background: 'linear-gradient(to right, rgba(13,13,26,0.88), rgba(13,13,26,0.5))' }} />
